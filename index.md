...
<video width="100%" controls>
  <source src="/gesture_recognition/assets/videos/gesture_recording.mp4" type="video/mp4">
</video>

# 🛠️ 技术方案

- 定义`draw_hand_landmarks()`函数，传入手部各坐标，在每个关节点画实心圆并连接
...
- 并且对于特殊手势如9，7，0做出区分:
	...
	- 7: 中指食指拇指接触，无名指和小指弯曲
	- 0: 食指大拇指接触，其他伸直
- 手指伸直使用使用 MCP → TIP 距离与各节长度之和的比值，对拇指使用 IP 关节角度辅助判断。
- 手指接触直接坐标距离判断
